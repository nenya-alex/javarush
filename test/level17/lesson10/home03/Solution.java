...
*/
//Задача полный отстой!!! Не указано, что должно быть в результате выполнения программы.
// И в начале, и после принятия на сервере, код выдает полный бред. Логики в задаче НОЛЬ!!!
