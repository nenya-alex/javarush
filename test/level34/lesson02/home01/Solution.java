...
Выражение включает целые и дробные числа, скобки (),
пробелы, знак отрицания -, возведение в степень ^, sin(x), cos(x), tan(x)
Для sin(x), cos(x), tan(x) выражение внутри скобок считать градусами,
например, cos(3 + 19*3)=0.5
...
public class Solution {
    public static void main(String[] args) {
        ...
        solution.recursion("sin(2*(-5+1.5*4)+28)", 6); //expected output 0.5 6
    }
