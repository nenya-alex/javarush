...
*/
// хорошая задача
// способ 1 - работает, но не принимается
...
//            List<String> st = OnlineGame.steps;
//            int k=0;
...
//                {
//                    k++;
//                    System.out.println(this.getName()+":"+st.get(i));
//                    try
//                    {
//                        Thread.sleep((long)1000 / st.size());
//                    }
...
public class Solution {
    ...
    public static class Gamer extends Thread {
        ...
        @Override
// мое решение, не принимает, но условия все выполнены
//        public void run() {
//            //Add your code here - добавь код тут
//            List<String> st = OnlineGame.steps;
//            int k=0, n=0;
...
//                    i++;
//                    n++;
//                    //System.out.println(this.getName()+" "+n+" "+k);
//                    if (n == st.size())
//                    {
//                        //System.out.println(this.getName() + ":победитель!");
//                        break;
...
////            }
//        }
        // принимает этот списаный выриант
        public void run() {
            //Add your code here - добавь код тут
